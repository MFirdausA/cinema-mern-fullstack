                        ...
                        <div className="flex items-center justify-between gap-2">
                            <div className="flex items-center gap-[14px]">
                                ...
                                <div className="flex flex-col gap-[6px]">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <img src="/images/icons/calendar-2-grey.svg" className="w-[18px] h-[18px] flex shrink-0" alt="icon" />
                                        <p className="text-sm text-premiere-grey">{dateFormat(item.date, "HH:mm, DD MMMM YYYY")}</p>
                                    </div>
