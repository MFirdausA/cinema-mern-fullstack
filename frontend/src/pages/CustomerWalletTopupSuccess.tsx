                ...
                <div className="flex flex-col max-h-screen">
                    ...
                    <div className="relative flex flex-col items-center gap-[30px] mb-[70px] mt-auto px-5">
                        <div className="flex flex-col w-[340px] gap-[6px] items-center">
                            <img src="/images/icons/note-favorite.svg" className="w-[50px] h-[50px] flex shrink-0" alt="icon" />
                        ...
                        <div className="flex flex-col gap-3 w-[220px]">
                            <Link to="/wallets" className="w-full rounded-full p-[12px_18px] bg-white text-black font-bold text-premiere-black text-center">View My Ewallet</Link>
                            <Link to="/wallets/topup" className="w-full rounded-full p-[12px_18px] bg-white/10 font-bold text-center backdrop-blur-sm">Topup Again</Link>
                        </div>
                    </div>
                </div>
            </div>
