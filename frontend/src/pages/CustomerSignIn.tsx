  ...
  return (
    <div id="Content-Container" className="relative flex flex-col w-full max-w-[640px] min-h-screen mx-auto bg-[linear-gradient(179.86deg,_#000000_40.82%,_#0E0E24_99.88%)] overflow-x-hidden">
      <div id="Background" className="absolute top-0 w-full h-[480px]">
        ...
        <img src="/images/backgrounds/signin.png" className="w-full h-full object-cover" alt="background" />
      </div>
      <img src="/images/logos/logo.svg" className="relative flex max-w-[188px] mx-auto mt-[274px]" alt="logo" />
      <form onSubmit={handleSubmit(onSubmit)} className="relative flex flex-col gap-[30px] px-5 py-[60px] my-auto">
        <h1 className="font-bold text-[26px] leading-[39px] text-white">Sign In</h1>
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link to="/sign-up" className="w-full rounded-full py-3 px-[18px] bg-white/10 text-center font-bold text-white">
            Create New Account
          </Link>
        </div>
      </form>
