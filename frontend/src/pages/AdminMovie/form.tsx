...
export default function AdminMovieForm() {
    ...
    const onSubmit = async (val: MovieValues) => {
        try {
            ...
            toast.success(
                `Movie successfully ${detail === null ? "created" : "updated"}`
            )
        } catch (error) {
            console.log(error)
            toast.error("Failed to create Movie0")
        }
    };

    return (
        <>
            <TitleHeading title={`${detail === null ? "Create" : "Update"} Data movie`} />
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <Select onValueChange={field.onChange}
                                    ...
                                    <FormControl>
                                        <SelectTrigger>
                                            <SelectValue placeholder="Select a movie genre" />
                                        </SelectTrigger>
                                    </FormControl>
                                    <SelectContent>
                                        {genres.map((val, i) => (
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <FormItem className="flex flex-row items-start items-center space-x-3 space-y-0 rounded-md border p-4">
                                        <FormControl>
                                            <Checkbox checked={field.value} onCheckedChange={field.onChange} />
                                        </FormControl>
                                        <div className="flex space-y-0 items-center leading-none">
